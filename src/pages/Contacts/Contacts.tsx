...
export default function Contacts() {
  ...
  const [personRows, setPersonRows] = useState<Person[]>([]);
  ...
  const loadContacts = useCallback(async () => {
    ...
    try {
      ...
      if (selectedTab === 0) {
        ...
        setPersonRows(res.data.items);
        setTotalCount(res.data.totalCount);
      } else {
        const res: ApiResponse<PagesOrganizationResponse> =
          await getFilteredOrganizationsByProject(filter);

        setOrganizationRows(res.data.items);
        setTotalCount(res.data.totalCount);
      }
    } finally {
      setIsLoading(false);
                  ...
                  <TableHead>
                    <TableRow>
                      <TableCell>
                        <TableSortLabel
                          active={sortBy === "name"}
                          direction={sortBy === "name" ? muiDirection : "asc"}
                      ...
                      <TableCell>
                        <TableSortLabel
                          active={sortBy === "phone"}
                          direction={sortBy === "phone" ? muiDirection : "asc"}
                      ...
                      <TableCell>
                        <TableSortLabel
                          ...
                          direction={
                            sortBy === "projects" ? muiDirection : "asc"
                          }
                      ...
                      {isPersonTab && (
                        <TableCell>
                          <TableSortLabel
                            ...
                            direction={
                              sortBy === "organization" ? muiDirection : "asc"
                            }
